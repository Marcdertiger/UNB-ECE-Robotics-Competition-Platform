...
#
#Initialize some robot attributes
#
#
#
...
def receivedata():
	...
	try:
		string = targcom.recv(flags=zmq.NOBLOCK)
   		tcommandtopic,tIDe,tdrive,taux,tspecial1,tspecial2,tcommandreport,trequest = string.split()
		print "PS3client-receive-from-target-controller"
		print (tcommandtopic,tIDe,tdrive,taux,tspecial1,tspecial2,tcommandreport,trequest)
	...
	#receive general commands here (to all robots)
		...
		print (commandtopic,IDe,drive,aux,special1,special2,commandreport,request)
	except:
		pass
