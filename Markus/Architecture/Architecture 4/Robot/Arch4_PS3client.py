...
#title           :Arch4_PS3client.py
#description     :Receive robot data, update robot status table in Controller database.
#date            :Summer 2016
#version         :4
#usage           :sudo python Arch4_PS3client.py argument1=robotname argument2=serverIP
...
#
#Will wait until database write is commited proprely.
#
...
socketS.connect ("tcp://%s:%s" % (serverIP, port)) #server IP
...
targcom.connect ("tcp://%s:%s" % (serverIP,port)) #server IP
